...
int			ft_bonus(int ac, char **av)
{
	...
	ft_printf("TODO: `test` builtin\n");
	ft_printf("TODO: conditional builtins: if, while, for, case, esac, do, done, in, then, until, elif, else, fi, !, {, }...\n");
	ft_printf("TODO: function syntax storage and execution\n");
	...
	ft_printf("TODO: unterminated quote, dbqutoe, (), $(), `, for, if, while, ... on multiline prompt\n");
	ft_printf("TODO: advanced builtins: $?, $$, $!, $_, ($*, $@, $#, $-, $0); cd -1, -2, ...; !-1, !-2 ...\n");
	ft_printf("TODO: advanced ${} operations: ${#var}, ${var/s/s} ...\n");
	ft_printf("TODO: <<\n");
	ft_printf("TODO: ` and $()\n");
	ft_printf("TODO: ctrl-R for history searches\n");
	ft_printf("TODO: animated prompt\n");
	ft_printf("TODO: reptyr\n");
